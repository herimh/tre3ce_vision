...
public class OcrGraphic extends GraphicOverlay.Graphic {
    ...
    OcrGraphic(GraphicOverlay overlay, String[] credential) {
        super(overlay);
    ...
    public void draw(Canvas canvas) {
        if (credential[0] != null && credential[0] != ""){ //Name
            ...
            canvas.drawText(credential[0]+" "+credential[1]+" "+credential[2], 10, 180, sTextPaint);
        }

        if (credential[3] !=null && credential[3] != ""){ //Elector Key
